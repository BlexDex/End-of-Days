...
public class RangerTower : MonoBehaviour
{
    private Camera cam;
    ...
    void Update()
    {
        if (ResourceManager.Instance.GetResourceAmount(ResourceManager.ResourceType.Food) >= 100)
        {
            isAvailable = true;
        }
        else
    ...
    {
        ResourceManager.Instance.DecreaseResource(ResourceManager.ResourceType.Food, 100);
